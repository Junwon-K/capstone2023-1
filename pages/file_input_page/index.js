...
import { Wrapper, Header, HeaderContainer, Body, MainMenu, PageButton, 
         ...
         Blank, SendBox, ContainerLeft, ContainerRight, LoginButton, MenuImage} from "../../styles/file_input_page";        
...
export default function File() {
  ...
  const handleUpload = () => {
    ...
    axios.post(`http://34.121.32.11:8080/video?userIdx=${userIdx}&category=bottle`, fd, {
        headers: {
            "Content-Type": `multipart/form-data;`,
        },
        onUploadProgress: progressEvent => {
