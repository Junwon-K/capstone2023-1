...
import { Wrapper, Navigator, Content, MainMenu, MakeFile, TextTitle, 
         ...
         TextBox, Text1, Text2, MenuImage} from "../../../styles/dashboard_model";
    ...
    return (
        <Wrapper>
            ...
            <Content>
                <ContentHeader>
                    <TextBox>
                        <Text1>생성된 모델 목록</Text1>
                        <Text2>지금까지 만들어진 3D 모델을 볼 수 있어요!</Text2>
                    </TextBox>
                </ContentHeader>
                <ContentBody>
...
//                 <ContentBody>
//                     <Product />
//                     {/* Render Product component multiple times as needed */}
//                     {/* <Product />
//                     <Product /> */}
//                 </ContentBody>
//             </Content>
